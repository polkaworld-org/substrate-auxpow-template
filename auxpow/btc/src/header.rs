...
mod tests {
	...
	fn test_block_merkle_root_and_hash() {
        ...
        let merkle_root = H256::from_str("190760b278fe7b8565fda3b968b918d5fd997f993b23674c0af3b6fde300b38f").unwrap();
		let hash = H256::from_str("f6ba93bddb7bb20d78d2ef190d0106a4a2ca9067726f1dfdc0a8430000000000").unwrap();
